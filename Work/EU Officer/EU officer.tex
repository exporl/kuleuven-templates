...
\begin{frame}{Ideal ultrasound imaging system}
...
%\caption{\tiny{Linear array}}
\endminipage
\minipage{0.5\textwidth}
\centering
\includegraphics[width=1\textwidth]{32.png}\\
\includegraphics[width=.65\textwidth]{34.png}
%\caption{\tiny{2D array} }
\endminipage
\end{figure}
...
\emptyfooter
\begin{frame}{\centering \Huge System operation}
\begin{figure}[!htb]
\centering
...
\begin{enumerate} 
\vspace{0.05cm}
     \item \tiny{\textbf{\textit{A-mode}}} 
     \item \tiny{\textbf{\textit{B-mode}}} 
     \item \tiny{\textbf{\textit{FRD}}} 
     \item \tiny{\textbf{\textit{....}}}
\end{enumerate}
\end{block}

\begin{center}
\textbf{\textit{At the lab}}
\end{center}
