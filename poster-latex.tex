...
\title{\Huge Implementation of fast echocardiographic scan sequences on an experimental system}
\author{\href{Vangjush.Komini@uzleuven.be}{\Huge Vangjush Komini}}
\institute{\href{www.kuleuven.be}{\Huge KU Leuven}}
