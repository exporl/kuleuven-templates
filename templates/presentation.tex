...
{%
    ...
    \hskip1.8cm%
    \vbox to \paperheight{%
        \vskip8.68cm\hskip10.33cm\includegraphics[width=2.10cm]{templates/kuleuven}\vfill%
    }%
}
...
$if(sectiontoc)$
\AtBeginSection[]{{
    \renewcommand{\insertsupertitle}{}
    \setbeamertemplate{background canvas}[kul]\setbeamertemplate{footline}[nopagenumber]
    \begin{frame}[noframenumbering]{Outline}
        ...
        $endif$
    \end{frame}
    \setbeamertemplate{background canvas}[kul]\setbeamertemplate{footline}[large]
}}
$endif$
