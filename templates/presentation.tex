...
$if(show-total-number-of-slides)$
\usepackage{appendixnumberbeamer}  % don't include appendix slides in slide count, restart numbering for appendix
$endif$
...
\usepackage{ marvosym }
\usetikzlibrary{positioning, calc, arrows, fit, shapes.geometric}
...
\ExecuteBibliographyOptions{
    ...
    doi=false,
    url=false,
    date=year						% No month in citation
$if(biboptions)$
    ,$biboptions$
$endif$
}
...
\definecolor{kulcolor}{HTML}{24417a}

\setbeamercolor{structure}{fg=kulcolor}
...
{%
    ...
    \insertframenumber$if(show-total-number-of-slides)$~/ \inserttotalframenumber$endif$%
    \end{beamercolorbox}%
    \vskip-0.92cm%
...
{%
    ...
    \mdseries\insertframenumber$if(show-total-number-of-slides)$~/ \inserttotalframenumber$endif$%
    \end{beamercolorbox}%
}

\defbeamertemplate{footline}{nofooter}
{%
}

\defbeamertemplate{footline}{referencefooter}
{%
\vskip.3cm% make room for the logo
\begin{beamercolorbox}[ht=0.37cm,dp=0.25cm,left,leftskip=2ex,ignorebg]{normal text}%
\insertfootlineextra
\end{beamercolorbox}%
}
...
{%
    \nointerlineskip%
    \vskip.28cm%
    {\usebeamercolor[fg]{framesubtitle}\usebeamerfont{framesubtitle}\insertsupertitle\hfill\tiny\insertframenumber$if(show-total-number-of-slides)$~/ \inserttotalframenumber$endif$\strut\par}%
    \vskip-.2cm%
...
\setbeamertemplate{title page}
	{
		...
		\node [anchor=north west,xshift=0.0525\paperheight,yshift=-.0525\paperheight,inner sep=0pt]
			...
			{\includegraphics[height=.105\paperheight]{templates/kuleuven}};

		% Sedes
		\node [anchor=south east,inner sep=0pt]
			at (current page.south east)
			{\includegraphics[height=.8\paperheight]{templates/sedesblue} };
		...
		\node [white, text width=.7\paperwidth, text depth=0pt,
			...
			font=\fontsize{10}{11}]
			at (current page.south west)
			{\insertauthor \\ \vspace{3pt} \insertinstitute \\ \vspace{3pt} \insertdate };
...
\newcommand{\referencefooter}{\setbeamertemplate{footline}[referencefooter]}
